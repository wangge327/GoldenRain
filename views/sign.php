...
<body>
    ...
    <div class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-3 document-right-side">
                        ...
                        <div id="history" class="tab-pane fade in active">
                            ...
                            <div class="timeline">
                                ...
                                <ul>
                                    ...
                                    <li class="{{ $history->type }}"><em class="text-xs">{{ setToUserTimezone($history->time_,$user->timezone) }}</em> {{ $history->activity }}</li>
                                    @endforeach
                                </ul>
                                <div class="circle"></div>
                            </div>
    ...
    <div class="signer-overlay">
        <div class="signer-overlay-header">
            <div class="signer-overlay-logo">
                <a href="<?= url("/"); ?>"><img src="<?= url("/"); ?>assets/images/app/{{ env('APP_LOGO'); }}" class="img-responsive"></a>
            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <select class="form-control send-to-server-change" name="public_permissions" url="<?= url("Document@permissions"); ?>" extradata="document:{{ $document->id }}|csrf-token:{{ csrf_token() }}">
                                    <option value="sign_edit" @if( $document->public_permissions == "sign_edit" )
                                        selected @endif>Can Sign and Edit file</option>
                                    <option value="read_only" @if( $document->public_permissions == "read_only" )
                                        selected @endif>Read/View Only</option>
                                    <option value="disabled" @if( $document->public_permissions == "disabled" )
                                        selected @endif>Disabled (Signing requests allowed)</option>
                                </select>
                            </div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-form" action="<?= url("Document@replace"); ?>" data-parsley-validate="" loader="true" method="POST">
                    <div class="modal-body">
                        <p>Replacing a file will keep all the document history and settings. Only PDF allowed.</p>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="simcy-front-form" callback="updateRequestFields()" data-parsley-validate="" loader="true" method="POST">
                    <div class="modal-body">
                        <p><?php echo env("APP_NAME") ?> requested some fields from you.</p>
    ...
    <!-- Edit rubber stamp Modal -->
    <div class="modal fade" id="editStamp" role="dialog">
        <div class="close-modal" data-dismiss="modal">&times;</div>
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Edit Rubber Stamp</h4>
                </div>
                <div class="modal-body">
                    <p>Edit your rubber stamp.</p>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                <label>Choose Stamp Color</label>
                                <input class="form-control stamp-color jscolor { valueElement:null,borderRadius:'1px', borderColor:'#e6eaee',value:'000000',zIndex:'99999', onFineChange:'updateStampColor(this)'}" id="stamp-color" readonly="">
                            </div>
                            <div class="col-md-6">
                                <label>Rotate stamp (Degrees)</label>
                                <input type="number" class="form-control rotate-stamp" value="0">
                            </div>
                        </div>
                    </div>
                    <div class="stamp-preview" contenteditable="true"></div>

                    <div class="form-group save-stamp mt-30">
                        <div class="row">
                            <div class="col-md-12">
                                <label><input type="checkbox" class="switch" name="savestamp" value="yes" /> Save this rubber stamp.</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger pull-left delete-stamp">Delete Stamp</button>
                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary stamp-document">Stamp Document</button>
                </div>
            </div>
    ...
    <div class="modal fade" id="sendRequest" role="dialog">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Lease Agreement Signature Request</h4>
                </div>
                <form class="simcy-front-form" callback="validateRequest()" data-parsley-validate="" loader="false" method="POST">
                    <div class="modal-body">
                        ...
                        <p>A copy of this template will be created on the documents folder for this signing request. If there are any fields the student will be asked to fill.</p>
                        @endif
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Message to students</label>
                                    <textarea class="form-control" name="requestmessage" rows="3" required="" placeholder="Message to students"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-muted">Enter email addresses of the students separated by a comma.</p>
                                    <input type="text" name="recipients" class="form-control" placeholder="Enter emails or select from below" data-role="tagsinput" data-parsley-required="true">
                                    <p></p>
                                    <input type="hidden" name="document_key" value="{{ $document->document_key }}" />
                                    <input type="hidden" name="csrf-token" value="{{ csrf_token() }}" />
                                </div>
                        ...
                        <div class="form-group restricted-request">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>
                                        <input type="checkbox" class="switch" name="restricted" value="1" /> Student to sign specific points or add inputs.
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group chain-request" style="display: none;">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>
                                        <input type="checkbox" class="switch" name="chain" value="1" /> Send a chained/sequential request
                                    </label>
                                    <br><span class="text-muted text-xs"> Request will be sent to the first email and after it's accepted and signed, it sent to the second email. The chain breaks when it's declined by any student.</span>
                                </div>
                            </div>
                        </div>
                        @if ( $user->role != "user" )
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="select-from-tabs">
                                        <ul class="tabs">
                                            ...
                                            <li><a data-toggle="tab" href="#send-customers">Students </a></li>
                                        </ul>
                                        <div class="tab-content">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <label>Message to students</label>
                                    <textarea class="form-control" name="message" rows="3" required="" placeholder="Message to students"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="text-muted">Enter email addresses of the students separated by a comma.</p>
                                    <input type="text" name="receivers" class="form-control" placeholder="Enter emails or select from below" data-role="tagsinput" data-parsley-required="true">
                                    <p></p>
                                    <input type="hidden" name="document_key" value="{{ $document->document_key }}" />
                                    <input type="hidden" name="csrf-token" value="{{ csrf_token() }}" />
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="select-from-tabs">
                                        <ul class="tabs">
                                            <li class="active"><a data-toggle="tab" href="#send-team-action-send">Team/Staff</a></li>
                                            <li><a data-toggle="tab" href="#send-customers-action-send">Customers </a></li>
                                        </ul>
                                        <div class="tab-content">
                                            <div id="send-team-action-send" class="tab-pane fade in active">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        @if ( !empty($team) )
                                                        @foreach ( $team as $member )
                                            ...
                                            <div id="send-customers-action-send" class="tab-pane fade">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        @if ( !empty($customers) )
                                                        @foreach ( $customers as $customer )
    ...
    <div class="right-bar chat-holder light-card">
                        ...
                        <div class="chat-message chat-message-recipient" id="{{ $chat->id }}">
                            ...
                            <div class='chat-message-wrapper'>
                                ...
                                <div class='chat-details'>
                                    <span class='chat-message-localization font-size-small'>{{ setToUserTimezone($chat->time_,$user->timezone) }}</span>
                                </div>
                            </div>
                        </div>
                        @endforeach
        ...
        <div class="right-bar font-list light-card">
            ...
            <div class="right-bar-body">
                <div class="font-list">
                    ...
                    <div class="font-item" font="rubik" family="'Reem Kufi', sans-serif" style="font-family:'Reem Kufi', sans-serif;">Rubik (Hebrew)</div>
                    <div class="font-item" font="manrope" family="'Manrope', sans-serif" style="font-family:'Manrope', sans-serif;">Manrope (Cyrillic)</div>
        ...
        <div class="right-bar input-fields-list light-card">
            ...
            <div class="right-bar-body">
                <div class="input-field-list">
                    <p class="text-muted">These are fields a student will fill when they receive a signing request</p>
        ...
        <!-- stamp list -->
        <div class="right-bar stamp-list light-card">
            <div class="right-bar-head">
                <div class="pull-right close-right-bar-head close-right-bar"><i class="ion-ios-close-outline"></i></div>
                <h4>Select Stamp</h4>
            </div>
            <div class="right-bar-body">
                <div class="stamp-list grid">
                    @if ( !empty($stamps) )
                    @foreach ( $stamps as $stamp )
                    <div class="stamp-item saved stamp-{{ $stamp->id }}" data-id="{{ $stamp->id }}">{{ $stamp->value }}</div>
                    @endforeach
                    @endif
                    {{ view("svg/stamps"); }}
                </div>
        ...
        <div class="right-bar symbol-list light-card">
            ...
            <div class="right-bar-body">
                <div class="symbol-list">
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 249.425 249.425" style="enable-background:new 0 0 249.425 249.425;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 52 52" style="enable-background:new 0 0 52 52;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.999 511.999" style="enable-background:new 0 0 511.999 511.999;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="438.533px" height="438.533px" viewBox="0 0 438.533 438.533" style="enable-background:new 0 0 438.533 438.533;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 60 60" style="enable-background:new 0 0 60 60;" xml:space="preserve">
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="44.238px" height="44.238px" viewBox="0 0 44.238 44.238" style="enable-background:new 0 0 44.238 44.238;" xml:space="preserve">
                            <g>
                                <g>
                                    <g>
                                        <path d="M15.533,29.455c-0.192,0-0.384-0.073-0.53-0.22c-0.293-0.293-0.293-0.769,0-1.062l13.171-13.171               c0.293-0.293,0.768-0.293,1.061,0s0.293,0.768,0,1.061L16.063,29.235C15.917,29.382,15.725,29.455,15.533,29.455z" />
                                    </g>
                                    <g>
                                        <path d="M28.704,29.455c-0.192,0-0.384-0.073-0.53-0.22L15.002,16.064c-0.293-0.293-0.293-0.768,0-1.061s0.768-0.293,1.061,0               l13.171,13.171c0.293,0.293,0.293,0.769,0,1.062C29.088,29.382,28.896,29.455,28.704,29.455z" />
                                    </g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 51.997 51.997" style="enable-background:new 0 0 51.997 51.997;" xml:space="preserve">
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 33.875 33.875" style="enable-background:new 0 0 33.875 33.875;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="438.536px" height="438.536px" viewBox="0 0 438.536 438.536" style="enable-background:new 0 0 438.536 438.536;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="401.998px" height="401.998px" viewBox="0 0 401.998 401.998" style="enable-background:new 0 0 401.998 401.998;" xml:space="preserve">
                            <g>
                    ...
                    <div class="symbol-item"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 19.481 19.481" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 19.481 19.481">
                            <g>
                                <path d="m10.201,.758l2.478,5.865 6.344,.545c0.44,0.038 0.619,0.587 0.285,0.876l-4.812,4.169 1.442,6.202c0.1,0.431-0.367,0.77-0.745,0.541l-5.452-3.288-5.452,3.288c-0.379,0.228-0.845-0.111-0.745-0.541l1.442-6.202-4.813-4.17c-0.334-0.289-0.156-0.838 0.285-0.876l6.344-.545 2.478-5.864c0.172-0.408 0.749-0.408 0.921,0z" />
                            </g>
                        </svg></div>
                    <div class="symbol-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 55.867 55.867" style="enable-background:new 0 0 55.867 55.867;" xml:space="preserve">
        ...
        <div class="right-bar shape-list light-card">
            ...
            <div class="right-bar-body">
                <div class="shape-list">
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.285 511.285" style="enable-background:new 0 0 511.285 511.285;" xml:space="preserve">
                            <g>
                                <g>
                                    <path d="M425.712,465.099l-160-458.667c-3.008-8.576-17.152-8.576-20.139,0l-160,458.667c-0.405,1.131-0.597,2.304-0.597,3.52          c0,41.472,153.195,42.667,170.667,42.667s170.667-1.195,170.667-42.667C426.309,467.424,426.117,466.229,425.712,465.099z" />
                                </g>
                            </g>
                            <g></g>
                            <g></g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 31.494 31.494" style="enable-background:new 0 0 31.494 31.494;" xml:space="preserve">
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512.01 512.01" style="enable-background:new 0 0 512.01 512.01;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.995 511.995" style="enable-background:new 0 0 511.995 511.995;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                                    <path d="M501.333,96H10.667C4.779,96,0,100.779,0,106.667v298.667C0,411.221,4.779,416,10.667,416h490.667         c5.888,0,10.667-4.779,10.667-10.667V106.667C512,100.779,507.221,96,501.333,96z" />
                                </g>
                            </g>
                            <g></g>
                            <g></g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 31.49 31.49" style="enable-background:new 0 0 31.49 31.49;" xml:space="preserve">
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                                    <path d="M501.333,0H10.667C4.779,0,0,4.779,0,10.667v490.667C0,507.221,4.779,512,10.667,512h490.667          c5.888,0,10.667-4.779,10.667-10.667V10.667C512,4.779,507.221,0,501.333,0z" />
                                </g>
                            </g>
                            <g></g>
                            <g></g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                            <g>
                                <g>
                                    <path d="M501.333,0H10.667C4.779,0,0,4.779,0,10.667v490.667C0,507.221,4.779,512,10.667,512h490.667          c5.888,0,10.667-4.779,10.667-10.667V10.667C512,4.779,507.221,0,501.333,0z M490.667,490.667H21.333V21.333h469.333V490.667z" />
                                </g>
                            </g>
                            <g></g>
                            <g></g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 42 42" style="enable-background:new 0 0 42 42;" xml:space="preserve">
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.509 511.509" style="enable-background:new 0 0 511.509 511.509;" xml:space="preserve">
                            <g>
                                <g>
                    ...
                    <div class="shape-item"><svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 511.488 511.488" style="enable-background:new 0 0 511.488 511.488;" xml:space="preserve">
                            <g>
                                <g>
                                    <path d="M500.04,496.235L265.373,5.568c-3.541-7.424-15.701-7.424-19.243,0L11.464,496.235c-1.6,3.285-1.365,7.189,0.597,10.283            s5.355,4.971,9.024,4.971h469.333c3.669,0,7.083-1.877,9.024-4.971C501.384,503.424,501.619,499.541,500.04,496.235z             M38.003,490.155L255.752,34.88l217.749,455.275C473.501,490.155,38.003,490.155,38.003,490.155z" />
                                </g>
                            </g>
                            <g></g>
                            <g></g>
        ...
        <script src="<?= url("/"); ?>assets/libs/js-base64/base64.min.js"></script>
